      ...
      >
        ...
        >
          ...
          <g filter="url(#softGlow)">
            ...
            {/* Diamond tip */}
            <path
              d="M27.5 3 L28 1 L28.5 3 L28 6 Z"
              fill="url(#goldBase)"
              stroke="#E8C84A"
              strokeWidth="0.3"
            />
          ...
          <g filter="url(#softGlow)">
            <path
              d="M20 14 C17 17, 14 20, 13 23 C14 25, 16 26, 18 24 L22 16 Z"
              fill="url(#goldBase)"
            />
            <path
              d="M13 23 C14 25, 16 26, 18 24"
              fill="none"
              stroke="url(#edgeHighlight)"
              strokeWidth="0.4"
              opacity="0.5"
            ...
            <path
              d="M13 23 C14 24.5, 15.5 25.5, 17 24.5"
              stroke="#1A4A3A"
              strokeWidth="0.3"
              opacity="0.4"
            />
          ...
          <g filter="url(#softGlow)">
            <path
              d="M36 14 C39 17, 42 20, 43 23 C42 25, 40 26, 38 24 L34 16 Z"
              fill="url(#goldBase)"
            />
            <path
              d="M43 23 C42 25, 40 26, 38 24"
              fill="none"
              stroke="url(#edgeHighlight)"
              strokeWidth="0.4"
              opacity="0.5"
            ...
            />
            <path
              d="M43 23 C42 24.5, 40.5 25.5, 39 24.5"
              stroke="#1A4A3A"
              strokeWidth="0.3"
              opacity="0.4"
            />
          ...
          {[0, 1, 2, 3, 4, 5].map((i) => {
            ...
            return (
              <g key={`glyph-band-${i}`}>
                ...
                <path
                  d={`M26 ${cy + 2} L28 ${cy} L30 ${cy + 2} L28 ${cy + 4} Z`}
                  stroke="#D4AF37"
                  strokeWidth="0.3"
                  fill="none"
                  opacity="0.4"
