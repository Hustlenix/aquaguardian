...
const assistantTips = [
  {
    ...
    detail: 'Summarize why coastal monitoring and habitat protection matter in straightforward language.',
  },
  {
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-10">
        ...
        <section className="rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-white">“Ask what the scene means, what the robot is doing, or why it matters.”</h2>
            <p className="mt-4 text-lg leading-8 text-text-muted">
              This experience can connect the story to evidence, explain the mission, and give users a simple layer of support as they explore the 3D narrative.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-3">
            {assistantTips.map((tip, index) => (
              ...
              >
                <p className="text-sm uppercase tracking-[0.3em] text-gold-400/70">Prompt {index + 1}</p>
