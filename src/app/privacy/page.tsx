      ...
      <div className="section-inner px-4 py-12">
        ...
        >
          ...
          <div className="space-y-8 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="heading-md text-white mb-3">2. Local Progress Data</h2>
              <p className="text-text-muted">
                Progress on missions, challenges, and learning modules is stored only in your
                browser&apos;s local storage so the experience can resume where you left off. It
                never leaves your device and is cleared when you clear your browser data.
              </p>
            </section>

            <section>
              <h2 className="heading-md text-white mb-3">3. How We Use Your Information</h2>
              <p className="text-text-muted">
            ...
            <section>
              <h2 className="heading-md text-white mb-3">4. Data Protection</h2>
              <p className="text-text-muted">
            ...
            <section>
              <h2 className="heading-md text-white mb-3">5. Your Rights</h2>
              <p className="text-text-muted">
            ...
            <section>
              <h2 className="heading-md text-white mb-3">6. Contact</h2>
              <p className="text-text-muted">
